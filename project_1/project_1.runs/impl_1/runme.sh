...
HD_PWD='/home/maria/toc2/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cerrojo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cerrojo.tcl -notrace
